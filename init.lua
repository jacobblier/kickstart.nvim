...
require('lazy').setup({
  ...
  -- Inline Git blame
  {
    ...
    opts = {
      ...
      gitblamedelay = 250, -- delay in milliseconds after which the blame info will be displayed.
    },
  },
  { 'github/copilot.vim' },
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- TODO: jacob Read and test all those following keymaps
          ...
          -- NOTE: jacob The documentation for `CursorHold` states that this will happen every `updatetime` interval, which is currently set to 250ms, which might be too short.
          ...
          -- TODO: jacob To test and see if it desirable.
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { javascript = true, proto = true }
  ...
  { -- Autocompletion
    ...
    dependencies = {
      -- Snippet Engine
      {
        ...
        -- TODO: jacob See if `friendly-snippets` is interesting to me.
        dependencies = {
  ...
  -- TODO jacob See how this plugin works and how to change the look of the comments (if desired).
  ...
  --  TODO: jacob See if those plugins warrant being included in my config
  --
  ...
  --  TODO: jacob Add the following line when I'm ready.
